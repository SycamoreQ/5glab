#!/usr/bin/env python3
"""
Standalone script to set up a test database with sample data.
Run this BEFORE running your tests.

Usage:
    python setup_test_database.py
    
This creates a test database at 'test_research_db/' with:
- Sample authors
- Sample papers  
- WROTE relationships (authorship)
- CITES relationships (citations)
"""
